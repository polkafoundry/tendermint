...
type CheckOpType int32

const (
	CheckOpType_New     CheckOpType = 0
	CheckOpType_Recheck CheckOpType = 1
)

var CheckOpType_name = map[int32]string{
	0: "CheckOpTypeNew",
	1: "CheckOpTypeRecheck",
}

var CheckOpType_value = map[string]int32{
	"CheckOpTypeNew":     0,
	"CheckOpTypeRecheck": 1,
}

func (x CheckOpType) String() string {
	return proto.EnumName(CheckOpType_name, int32(x))
}

func (CheckOpType) EnumDescriptor() ([]byte, []int) {
...
type Request_CheckOp struct {
	CheckOp *RequestCheckOp `protobuf:"bytes,16,opt,name=check_op,json=checkOp,proto3,oneof" json:"check_op,omitempty"`
}
...
func (*Request_CheckOp) isRequest_Value()            {}
...
func (m *Request) GetCheckOp() *RequestCheckOp {
	if x, ok := m.GetValue().(*Request_CheckOp); ok {
		return x.CheckOp
	}
	return nil
}
...
type Response_CheckOp struct {
	CheckOp *ResponseCheckOp `protobuf:"bytes,17,opt,name=check_op,json=checkOp,proto3,oneof" json:"check_op,omitempty"`
}
...
func (*Response_CheckOp) isResponse_Value()            {}
...
func (m *Response) GetCheckOp() *ResponseCheckOp {
	if x, ok := m.GetValue().(*Response_CheckOp); ok {
		return x.CheckOp
	}
	return nil
}
...
type RequestCheckOp struct {
	Op   []byte      `protobuf:"bytes,1,opt,name=op,proto3" json:"op,omitempty"`
	Type CheckOpType `protobuf:"varint,2,opt,name=type,proto3,enum=tendermint.abci.CheckOpType" json:"type,omitempty"`
}

func (m *RequestCheckOp) Reset()         { *m = RequestCheckOp{} }
func (m *RequestCheckOp) String() string { return proto.CompactTextString(m) }
func (*RequestCheckOp) ProtoMessage()    {}
func (*RequestCheckOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{44}
}
func (m *RequestCheckOp) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RequestCheckOp) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RequestCheckOp.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RequestCheckOp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestCheckOp.Merge(m, src)
}
func (m *RequestCheckOp) XXX_Size() int {
	return m.Size()
}
func (m *RequestCheckOp) XXX_DiscardUnknown() {
	xxx_messageInfo_RequestCheckOp.DiscardUnknown(m)
}

var xxx_messageInfo_RequestCheckOp proto.InternalMessageInfo

func (m *RequestCheckOp) GetOp() []byte {
	if m != nil {
		return m.Op
	}
	return nil
...
func (m *RequestCheckOp) GetType() CheckOpType {
	if m != nil {
		return m.Type
	}
	return CheckOpType_New
}

type ResponseCheckOp struct {
	Code      uint32  `protobuf:"varint,1,opt,name=code,proto3" json:"code,omitempty"`
	Data      []byte  `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"`
	Log       string  `protobuf:"bytes,3,opt,name=log,proto3" json:"log,omitempty"`
	Info      string  `protobuf:"bytes,4,opt,name=info,proto3" json:"info,omitempty"`
...
func (m *ResponseCheckOp) Reset()         { *m = ResponseCheckOp{} }
func (m *ResponseCheckOp) String() string { return proto.CompactTextString(m) }
func (*ResponseCheckOp) ProtoMessage()    {}
func (*ResponseCheckOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{45}
}
func (m *ResponseCheckOp) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ResponseCheckOp) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ResponseCheckOp.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ResponseCheckOp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResponseCheckOp.Merge(m, src)
}
func (m *ResponseCheckOp) XXX_Size() int {
	return m.Size()
}
func (m *ResponseCheckOp) XXX_DiscardUnknown() {
	xxx_messageInfo_ResponseCheckOp.DiscardUnknown(m)
}

var xxx_messageInfo_ResponseCheckOp proto.InternalMessageInfo

func (m *ResponseCheckOp) GetCode() uint32 {
	if m != nil {
		return m.Code
	}
	return 0
...
func (m *ResponseCheckOp) GetData() []byte {
	if m != nil {
		return m.Data
	}
	return nil
...
func (m *ResponseCheckOp) GetLog() string {
	if m != nil {
		return m.Log
	}
	return ""
...
func (m *ResponseCheckOp) GetInfo() string {
	if m != nil {
		return m.Info
	}
	return ""
...
func (m *ResponseCheckOp) GetGasWanted() int64 {
	if m != nil {
		return m.GasWanted
	}
	return 0
...
func (m *ResponseCheckOp) GetGasUsed() int64 {
	if m != nil {
		return m.GasUsed
	}
	return 0
...
func (m *ResponseCheckOp) GetEvents() []Event {
	if m != nil {
		return m.Events
	}
	return nil
...
func (m *ResponseCheckOp) GetCodespace() string {
	if m != nil {
		return m.Codespace
	}
	return ""
...
func (m *ResponseCheckOp) GetSender() string {
	if m != nil {
		return m.Sender
	}
	return ""
...
func (m *ResponseCheckOp) GetPriority() int64 {
	if m != nil {
		return m.Priority
	}
	return 0
...
func (m *ResponseCheckOp) GetMempoolError() string {
	if m != nil {
		return m.MempoolError
	}
	return ""
...
func (m *ResponseDeliverOp) Reset()         { *m = ResponseDeliverOp{} }
func (m *ResponseDeliverOp) String() string { return proto.CompactTextString(m) }
func (*ResponseDeliverOp) ProtoMessage()    {}
func (*ResponseDeliverOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{46}
}
func (m *ResponseDeliverOp) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ResponseDeliverOp) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ResponseDeliverOp.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ResponseDeliverOp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResponseDeliverOp.Merge(m, src)
}
func (m *ResponseDeliverOp) XXX_Size() int {
	return m.Size()
}
func (m *ResponseDeliverOp) XXX_DiscardUnknown() {
	xxx_messageInfo_ResponseDeliverOp.DiscardUnknown(m)
}

var xxx_messageInfo_ResponseDeliverOp proto.InternalMessageInfo

func (m *ResponseDeliverOp) GetCode() uint32 {
	if m != nil {
		return m.Code
	}
	return 0
...
func (m *ResponseDeliverOp) GetData() []byte {
	if m != nil {
		return m.Data
	}
	return nil
...
func (m *ResponseDeliverOp) GetLog() string {
	if m != nil {
		return m.Log
	}
	return ""
...
func (m *ResponseDeliverOp) GetInfo() string {
	if m != nil {
		return m.Info
	}
	return ""
...
func (m *ResponseDeliverOp) GetGasWanted() int64 {
	if m != nil {
		return m.GasWanted
	}
	return 0
...
func (m *ResponseDeliverOp) GetGasUsed() int64 {
	if m != nil {
		return m.GasUsed
	}
	return 0
...
func (m *ResponseDeliverOp) GetEvents() []Event {
	if m != nil {
		return m.Events
	}
	return nil
...
func (m *ResponseDeliverOp) GetCodespace() string {
	if m != nil {
		return m.Codespace
	}
	return ""
...
func init() {
	...
	proto.RegisterEnum("tendermint.abci.CheckOpType", CheckOpType_name, CheckOpType_value)
	...
	proto.RegisterType((*RequestCheckOp)(nil), "tendermint.abci.RequestCheckOp")
	proto.RegisterType((*ResponseCheckOp)(nil), "tendermint.abci.ResponseCheckOp")
	proto.RegisterType((*ResponseDeliverOp)(nil), "tendermint.abci.ResponseDeliverOp")
}
...
var fileDescriptor_252557cfdd89a31a = []byte{
	...
	,
}
...
type ABCIApplicationClient interface {
	...
	CheckOp(ctx context.Context, in *RequestCheckOp, opts ...grpc.CallOption) (*ResponseCheckOp, error)
}
...
func (c *aBCIApplicationClient) CheckOp(ctx context.Context, in *RequestCheckOp, opts ...grpc.CallOption) (*ResponseCheckOp, error) {
	out := new(ResponseCheckOp)
	err := c.cc.Invoke(ctx, "/tendermint.abci.ABCIApplication/CheckOp", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ABCIApplicationServer interface {
	...
	CheckOp(context.Context, *RequestCheckOp) (*ResponseCheckOp, error)
}
...
func (*UnimplementedABCIApplicationServer) CheckOp(ctx context.Context, req *RequestCheckOp) (*ResponseCheckOp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CheckOp not implemented")
}
...
func _ABCIApplication_CheckOp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestCheckOp)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ABCIApplicationServer).CheckOp(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tendermint.abci.ABCIApplication/CheckOp",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ABCIApplicationServer).CheckOp(ctx, req.(*RequestCheckOp))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ABCIApplication_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CheckOp",
			Handler:    _ABCIApplication_CheckOp_Handler,
		},
	},
...
func (m *Request_CheckOp) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Request_CheckOp) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.CheckOp != nil {
		{
			size, err := m.CheckOp.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Response_CheckOp) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Response_CheckOp) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.CheckOp != nil {
		{
			size, err := m.CheckOp.MarshalToSizedBuffer(dAtA[:i])
...
func (m *RequestCheckOp) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RequestCheckOp) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RequestCheckOp) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ResponseCheckOp) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ResponseCheckOp) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ResponseCheckOp) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ResponseDeliverOp) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ResponseDeliverOp) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ResponseDeliverOp) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Request_CheckOp) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Response_CheckOp) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RequestCheckOp) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ResponseCheckOp) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ResponseDeliverOp) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 16:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CheckOp", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *RequestCheckOp) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RequestCheckOp: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RequestCheckOp: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= CheckOpType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ResponseCheckOp) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ResponseCheckOp: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ResponseCheckOp: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *ResponseDeliverOp) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ResponseDeliverOp: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ResponseDeliverOp: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
